        ...
        <section className='py-24'>
            ...
            <div className='bg-primaryBlue my-[150px] py-10 text-white'>
                <div className='w-full max-w-max mx-auto flex justify-center gap-20'>
                    <div className='max-w-[500px]'>
                        <h1 className='uppercase text-3xl'>Invest For Your Children Open a Gift Mutual Fund today</h1>
            ...
            <div className='relative py-12'>
                ...
                <div className='relative z-10 flex gap-20 max-w-[1100px] mx-auto'>
                    ...
                    <div>
                        <h2 className='text-primaryBlue text-3xl uppercase'>Talk to a Financial Advisor</h2>
                        ...
                        <button className='text-primaryBlue border-primaryBlue border mt-10 py-3 px-6 rounded-[6px]'>Contact Us</button>
