...
const EquityFundRedemptionForm = ({
    ...
    const createEmailTemplates = () => {
      ...
      <ul>
        <li><strong>PACAM Equity Fund Redemption:</strong> For redemptions within 90 days, 10% of the positive total returns of the units being redeemed will be charged on the date of redemption.</li>
        ...
        <li>Process this equity fund redemption request according to standard procedures and maintain all documentation as required.</li>
        <li><strong>Fund Type:</strong> PACAM Equity Fund - High growth potential with equity market exposure.</li>
      </ul>
    `;

        const fundManagerTemplate = EmailTemplateGenerator.createTemplate({
            title: 'PACAM Equity Fund Redemption Request',
            subtitle: 'New equity fund redemption submission',
            greeting: 'A new PACAM Equity Fund redemption request has been submitted through the online portal. Please review the details below and process accordingly.',
            sections: fundManagerSections,
            importantNotes: fundManagerImportantNotes,
            isUserCopy: false,
            brandName: 'PACAM Equity Fund',
            brandColor: '#059669', // Green for equity growth
        ...
        const userSections = [
            {
                title: 'Equity Fund Redemption Confirmation',
                content: `
          <p>Thank you for submitting your PACAM Equity Fund redemption request. We have received your application and will process it according to our standard procedures.</p>
          <div class="info-grid">
        ...
        const userTemplate = EmailTemplateGenerator.createTemplate({
            title: 'PACAM Equity Fund Redemption Confirmation',
            subtitle: 'Your equity fund redemption request has been received',
            greeting: `Dear ${formData.fullName},`,
            sections: userSections,
            importantNotes: `
        <ul>
          <li>Your equity fund redemption request is being processed and you will receive confirmation once completed.</li>
          ...
          <li>PACAM Equity Fund focuses on long-term capital growth through equity investments.</li>
          <li>If you have any questions about your equity fund investment, please contact our customer service team.</li>
        </ul>
      `,
            isUserCopy: true,
            brandName: 'PACAM Equity Fund',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await EmailService.sendEmail(
                fundManagerEmail,
                'New PACAM Equity Fund Redemption Request',
                fundManagerTemplate,
                apiKey
            );
            ...
            if (formData.userEmail) {
                await EmailService.sendEmail(
                    formData.userEmail,
                    'Copy: Your PACAM Equity Fund Redemption Request',
                    userTemplate,
                    apiKey
                );
            }
            ...
            setSubmitStatus({
                type: 'success',
                message: 'PACAM Equity Fund redemption request submitted successfully! You should receive confirmation shortly.'
            });
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-t-lg shadow-lg p-6 border-b-4 border-green-600">
                    ...
                    <p className="text-center text-green-600 mt-2 font-medium">Equity Fund Unit Redemption</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-b-lg p-8 space-y-8">
                    ...
                    <div className="border-t pt-6">
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <h4 className="font-semibold text-green-800 mb-2">Important Notes for PACAM Equity Fund:</h4>
                            <ul className="text-sm text-green-700 space-y-1">
                                ...
                                <li>• <strong>Equity Fund Focus:</strong> This fund invests primarily in equity securities for long-term capital growth.</li>
                            </ul>
                        </div>
                    </div>
