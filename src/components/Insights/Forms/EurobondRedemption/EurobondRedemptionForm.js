// EurobondFundRedemptionForm.jsx - Modular structure with PDF generation
import React from 'react';
import { useEurobondFormLogic } from './useEurobondFormLogic';
import EurobondFormHeader from './EurobondFormHeader';
...
const EurobondFundRedemptionForm = ({
    ...
    const {
        ...
        handlePreviewPDF,
        closeModal
    } = useEurobondFormLogic(fundManagerEmail);
