// FixedIncomeFundRedemptionForm.jsx
...
const FixedIncomeFundRedemptionForm = ({
    ...
    const createEmailTemplates = () => {
      ...
      <ul>
        <li><strong>PACAM Fixed Income Fund Redemption:</strong> For redemptions within 90 days, 10% of the positive total returns of the units being redeemed will be charged on the date of redemption.</li>
        ...
        <li>Process this fixed income fund redemption request according to standard procedures and maintain all documentation as required.</li>
        <li><strong>Fund Type:</strong> PACAM Fixed Income Fund - Stable income generation through bond and fixed income securities.</li>
        <li><strong>Income Focus:</strong> Fixed income funds are designed for consistent returns and capital preservation.</li>
      </ul>
    `;

        const fundManagerTemplate = EmailTemplateGenerator.createTemplate({
            title: 'PACAM Fixed Income Fund Redemption Request',
            subtitle: 'New fixed income fund redemption submission',
            greeting: 'A new PACAM Fixed Income Fund redemption request has been submitted through the online portal. Please review the details below and process accordingly.',
            sections: fundManagerSections,
            importantNotes: fundManagerImportantNotes,
            isUserCopy: false,
            brandName: 'PACAM Fixed Income Fund',
            brandColor: '#7c3aed', // Purple for fixed income/bonds
        ...
        const userSections = [
            {
                title: 'Fixed Income Fund Redemption Confirmation',
                content: `
          <p>Thank you for submitting your PACAM Fixed Income Fund redemption request. We have received your application and will process it according to our standard procedures.</p>
          <div class="info-grid">
          ...
          <div class="info-grid">
            ...
            <div class="info-value">PACAM Fixed Income Fund (Stable Income Generation)</div>
          </div>
        `
            }
        ];
        ...
        const userTemplate = EmailTemplateGenerator.createTemplate({
            title: 'PACAM Fixed Income Fund Redemption Confirmation',
            subtitle: 'Your fixed income fund redemption request has been received',
            greeting: `Dear ${formData.fullName},`,
            sections: userSections,
            importantNotes: `
        <ul>
          <li>Your fixed income fund redemption request is being processed and you will receive confirmation once completed.</li>
          ...
          <li>Payment will be made to the account details you provided within 2-4 business days after processing.</li>
          <li>PACAM Fixed Income Fund focuses on stable income generation through bonds and fixed income securities.</li>
          <li>Fixed income funds are designed to provide consistent returns with lower volatility than equity investments.</li>
          <li>If you have any questions about your fixed income fund investment, please contact our customer service team.</li>
        </ul>
      `,
            isUserCopy: true,
            brandName: 'PACAM Fixed Income Fund',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await EmailService.sendEmail(
                fundManagerEmail,
                'New PACAM Fixed Income Fund Redemption Request',
                fundManagerTemplate,
                apiKey
            );
            ...
            if (formData.userEmail) {
                await EmailService.sendEmail(
                    formData.userEmail,
                    'Copy: Your PACAM Fixed Income Fund Redemption Request',
                    userTemplate,
                    apiKey
                );
            }
            ...
            setSubmitStatus({
                type: 'success',
                message: 'PACAM Fixed Income Fund redemption request submitted successfully! You should receive confirmation shortly.'
            });
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-100 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-t-lg shadow-lg p-6 border-b-4 border-purple-600">
                    ...
                    <p className="text-center text-purple-600 mt-2 font-medium">Stable Income Fund Unit Redemption</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-b-lg p-8 space-y-8">
                    ...
                    <div className="border-t pt-6">
                        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                            <h4 className="font-semibold text-purple-800 mb-2">Important Notes for PACAM Fixed Income Fund:</h4>
                            <ul className="text-sm text-purple-700 space-y-1">
                                ...
                                <li>• <strong>Stable Income Focus:</strong> This fund is designed for consistent income generation through bonds and fixed income securities.</li>
                                <li>• <strong>Capital Preservation:</strong> Fixed income funds offer lower volatility with steady returns for conservative investors.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="border-t pt-6">
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                <>
                                    <Send size={20} />
                                    Submit Fixed Income Fund Redemption
                                </>
                            )}
                        </button>
                    </div>
