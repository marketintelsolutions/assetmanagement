    ...
    return (
        <>
            ...
            <div className='w-full max-w-max mx-auto py-40'>
                ...
                <SlideIn duration={900} distance={70} direction="left" delay={250}> <p className='mt-10 text-[22px]'>Our Board consist of highly accomplished and experienced professionals, providing a diversity of expertise, and understanding of the financial services industry.</p></SlideIn>
