    ...
    return (
        <>
            ...
            <div className='w-full relative'>
...

                        {
                            wealthManagement.items.map((item, index) => (
                                <SlideIn duration={900} distance={90} direction="right" delay={index * 150}>
                                    <div className='bg-primaryBlue h-full py-6 md:py-12 px-5 md:px-7 text-white flex flex-col gap-5 md:gap-10 items-start '>
                ...
                <div className='w-full max-w-[1200px] px-6 xl:px-0 mx-auto flex flex-wrap lg:flex-nowrap gap-14 mb-24 items-start'>

                    <div className='w-full lg:max-w-[30%]'>
                        <h2 className='text-4xl font-medium text-primaryBlue font-poppins'>OUR SERVICES</h2>
                        <div className=' grid grid-cols-1 mb:grid-cols-2 md:grid-cols-3 lg:flex flex-col gap-6 mt-10 '>
                            {
                    ...
                    <div className='w-full h-[300px] md:h-[450px] object-cover relative '><div className='absolute top-0 left-0 w-full h-full bg-[#0000008e]'></div><img src="/corevalue.jpg" alt="corevalue" className='w-full h-full' /></div>
                </div>
            </div>
